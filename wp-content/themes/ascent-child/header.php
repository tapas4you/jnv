            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                   ...
                   <!--  <ul>
                    ...
                    <li><a href="create-account"><i class="fa fa-user-plus"></i> Register</a></li>
                    <li><span id="header-search-button"><i class="fa fa-search"></i> Search</span></li>
                    </ul> -->
...
<?php include_once 'header-banner.php' ?>
 ...
 <div class="main-content">
        ...
        <div class="<?php echo is_front_page() ? '' : 'container' ?>">
