...
?>
    ...
    while ( have_posts() ) : the_post(); ?> 
        ...
        <h1>Sign up</h1>
        <form name="registration" enctype="multipart/form-data" id="registration" action="" method="post">
            ...
            <div class="form-group">
                <div class="col-md-6">
                    <div class="row">
                        ...
                        <span class="col-md-8 col-sm-6"><input type="text" name="email" id="email" class="" tabindex="3" required></span>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="row">
