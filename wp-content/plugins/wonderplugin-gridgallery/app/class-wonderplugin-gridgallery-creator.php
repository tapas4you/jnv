...
class WonderPlugin_Gridgallery_Creator {
	...
	function render( $id, $config, $thumbnailsize ) {
		...
		<div id="wonderplugin-gridgallery-displaytitleineditor" style="display:none;"><?php echo get_option( 'wonderplugin_gridgallery_displaytitleineditor', 0 ); ?></div>
		<?php 
			$cats = get_categories();
			$catlist = array();
			foreach ( $cats as $cat )
		...
		<table class="wonderplugin-form-table">
			...
			<tr>
				...
				<td><div id="wonderplugin-gridgallery-categorylist"></div></td>
			</tr>
		</table>
		</div>
					...
					<div class="wonderplugin-gridgallery-options-tabs" id="wonderplugin-gridgallery-options-tabs">
						...
						<ul class="wonderplugin-tabs-horizontal" id="wonderplugin-lightbox-panels">
							...
							<tr valign="top">
								...
								<td><label for="wonderplugin-gridgallery-lightboxshowsocial"><input name="wonderplugin-gridgallery-lightboxshowsocial" type="checkbox" id="wonderplugin-gridgallery-lightboxshowsocial" /> Enable social media</label>
