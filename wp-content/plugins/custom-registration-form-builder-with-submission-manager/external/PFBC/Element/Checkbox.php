		...
		foreach($this->options as $value => $text) {
			...
			++$count;
                ...
                if(isset($this->_attributes["rm_is_other_option"]) && $this->_attributes["rm_is_other_option"] == 1){                    
                   ...
                   if(!$other_val)
                   {
                   echo '<input type="checkbox" value="" id="'.$this->_attributes["id"].'_other" name="'.$this->getAttribute("name").'" style="'.$this->getAttribute("style").'"><label for="'.$this->_attributes["id"].'_other">Other</label></li>'.
                   ...
                   {
                    echo '<input type="checkbox" value="" id="'.$this->_attributes["id"].'_other" name="'.$this->getAttribute("name").'" style="'.$this->getAttribute("style").'" checked><label for="'.$this->_attributes["id"].'_other">Other</label></li>'.
