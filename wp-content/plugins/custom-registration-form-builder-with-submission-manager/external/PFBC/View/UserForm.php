...
class View_UserForm extends View_SideBySide{
    ...
    protected function renderElement(Element $element)
    {
        ...
        {
            echo '<div class="'.$row_class.' rm_captcha_fieldrow">','<div class="'.$row_class.'">', $this->renderLabel($element), '<div class="'.$input_class.'" >', $element->render(), '</div>', $this->renderDescriptions($element), '</div></div>';            
        }
        else
        {
    ...
    protected function renderLabel(Element $element)
     {
        ...
        if($element instanceof Element_Captcha )
        {
            ...
            echo '<div class="'.$field_class.'" for="', $element->getAttribute("id"), '" ><label>';
            echo 'Captcha';
