    ...
    public static function get($identifier) {
        ...
        switch ($identifier) {
            ...
            case 'HELP_ADD_FIELD_LABEL':
                return __("Label of the field as it appears on forms and inside user accounts. This does not apply to fields without labels such as Divider, Spacing, Heading, Paragraph and Shortcode fields.", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_ADD_FIELD_SHOW_ON_USERPAGE':
                return __("If checked, the field value will appear inside User page in User Manager to you and in User Account section to User on front end. It can be useful if you wish to associate this field with the user for quick reference apart from the submission.", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'CRON_DISABLED_WARNING_INVITATION':
             ...
             case 'HELP_ADD_FIELD_IS_UNIQUE':
                return __("Mark this field as unique. No two users can submit same value for this field. Any subsequent attempt for submission with duplicate value will show a message.", 'custom-registration-form-builder-with-submission-manager');
