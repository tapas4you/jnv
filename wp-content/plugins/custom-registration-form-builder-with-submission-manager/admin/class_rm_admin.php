...
echo __('Form specific settings can be found on form dashboard.', 'custom-registration-form-builder-with-submission-manager');
	...
	public function add_version_header() {
        ...
        <style>
          ...
          .rmagic.rm-deactivate-view::before{ display:none}
        </style>
        <?php
}
	...
	public function feedback_dialog() {
		$deactivate_reasons = array(
			...
			'plugin_short_period' => array(
				'title' => 'I only needed the plugin for a short period',
				'input_placeholder' => '',
			),
			...
			'plugin_stopped_working' => array(
				'title' => 'The plugin suddenly stopped working',
				'input_placeholder' => '',
			),
        ...
        <script type="text/javascript">
            jQuery(document).ready(function(){
                ...
                jQuery(".rm-modal-close").click(function(){
                    jQuery(".rm-modal-view, .rm-modal-overlay").hide();
        ...
        <div class="rmagic rm-deactivate-view">
	...
	public function post_feedback() {
		...
		$body = '';
		switch ($feedback) {
		case 'no_longer_needed':$body = 'Plugin no longer needed';
			break;
		case 'found_a_better_plugin':$body = 'Found a better plugin.';
			break;
		case 'plugin_short_period':$body = 'Plugin needed for a short period of time.';
			break;
		case 'plugin_broke_site':$body = 'Plugin broke my site.';
			break;
		case 'plugin_stopped_working':$body = 'Plugin stopped working';
			break;
